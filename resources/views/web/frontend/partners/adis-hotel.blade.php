            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="row">
                     <div class="col-md-12">
                        <div class="img_box">
                           <figure><img src="{{ asset('partners/adis-hotel/images/img1.jpg') }}" alt="#"/></figure>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="img_box">
                           <figure><img src="{{ asset('partners/adis-hotel/images/img2.jpg') }}" alt="#"/></figure>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="img_box">
                           <figure><img src="{{ asset('partners/adis-hotel/images/img3.jpg') }}" alt="#"/></figure>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <div class="our">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-6">
                  <div class="img_box">
                     <figure><img src="{{ asset('partners/adis-hotel/images/img4.jpg') }}" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="our_box">
      ...
      <div id="about"  class="about">
         <div class="container-fluid">
            <div class="row d_flex">
               ...
               <div class="col-md-6">
                  <div class="about_img">
                     <figure><img src="{{ asset('partners/adis-hotel/images/about_img.jpg') }}" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-6 margin_boot">
                                       <div class="test_box">
                                          <h4>Mark jonson</h4>
                                          <i><img src="{{ asset('partners/adis-hotel/images/te1.png') }}" alt="#"/></i>
